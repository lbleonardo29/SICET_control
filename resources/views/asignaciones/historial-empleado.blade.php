...
@section('page-title', 'Historial del Empleado')
                ...
                <table class="table table-hover align-middle mb-0" id="historialTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($a->equipo)
                                    <div class="fw-bold">{{ $a->equipo->marca }} {{ $a->equipo->modelo }}</div>
                                    <small class="text-muted d-block">
                                        <i class="bi bi-upc-scan me-1"></i>
                                        {{ $a->equipo->codigo_interno }}
                                    </small>
                                @else
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                ...
                                <h4 class="text-muted">No hay historial para este empleado</h4>
                                <p class="text-muted mb-0">Este empleado no tiene computadoras asignadas</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
...
<script>
    ...
    function exportToExcel() {
        ...
        a.href = url;
        a.download = 'historial_empleado_{{ $empleado->numero_empleado }}.csv';
        a.click();

                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="ram" class="form-select form-select-lg @error('ram') is-invalid @enderror" required>
                                    ...
                                    <option value="2GB" {{ old('ram') == '2GB' ? 'selected' : '' }}>2GB</option>
                                    ...
                                    <option value="24GB" {{ old('ram') == '24GB' ? 'selected' : '' }}>24GB</option>
                                    <option value="32GB" {{ old('ram') == '32GB' ? 'selected' : '' }}>32GB</option>
                                    <option value="64GB" {{ old('ram') == '64GB' ? 'selected' : '' }}>64GB</option>
                                    <option value="128GB" {{ old('ram') == '128GB' ? 'selected' : '' }}>128GB</option>
                                </select>
                                @error('ram')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror

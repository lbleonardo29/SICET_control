    ...
    <div class="card shadow-lg border-0" style="max-width: 500px; margin: 0 auto;">
        <div class="card-body p-5">
            @if($tipo == 'aceptada')
                ...
                <p class="text-muted mt-3">El dispositivo móvil ha sido registrado a tu nombre correctamente.</p>
            @else
                <div class="mb-4">
                ...
                <p class="lead">{{ $mensaje }}</p>
                <p class="text-muted mt-3">El dispositivo móvil no ha sido asignado.</p>
            @endif
